...
var _jsxFileName = "D:\\Webdev\\nodebird_fullstack\\front\\components\\AppLayout.js";
...
var _jsxFileName = "D:\\Webdev\\nodebird_fullstack\\front\\components\\LoginForm.js";
...
var LoginForm = function LoginForm() {
  var _useInput = Object(_components_SignupForm__WEBPACK_IMPORTED_MODULE_4__["useInput"])(""),
      _useInput2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useInput, 2),
      id = _useInput2[0],
      onChangeId = _useInput2[1];

  var _useInput3 = Object(_components_SignupForm__WEBPACK_IMPORTED_MODULE_4__["useInput"])(""),
...
var _jsxFileName = "D:\\Webdev\\nodebird_fullstack\\front\\components\\SignupForm.js";
...
var SignupForm = function SignupForm() {
  ...
  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(false),
      ...
      setTermError = _useState10[1]; // 자식컴포넌트에 props 로 넘기는 함수들은 useCallback으로 감싸줘야한다
  ...
  useEffect(function () {
    if (me) {
      next_router__WEBPACK_IMPORTED_MODULE_5___default.a.push("/"); // 회원가입하고 로그인되면 바로 메인으로가게
    }
  }, [me && me.id]); // 가드해주기
  ...
  }, [password, passwordCheck, term]); // useCallback을 쓰려면 dependecny 에 이용하는 state값들 다넣어줘야함
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_2__["Form"], {
    ...
    __self: this
  }, "\uB3D9\uC758\uD569\uB2C8\uAE4C"), TermError && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    style: {
      color: "red"
    },
    __source: {
    ...
    __self: this
  }, "\uC57D\uAD00\uC5D0 \uB3D9\uC758\uD558\uC138\uC694!! ")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    style: {
      marginTop: 10
    },
    __source: {
...
var _jsxFileName = "D:\\Webdev\\nodebird_fullstack\\front\\components\\UserProfile.js";
...
var _jsxFileName = "D:\\Webdev\\nodebird_fullstack\\front\\pages\\_app.js";
...
var NodeBird = function NodeBird(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_6__["Provider"], {
    ...
    __self: this
  }, "SteveBird"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("link", {
    rel: "stylesheet",
...
var configureStore = function configureStore(initState, options) {
  var sagaMiddleware = redux_saga__WEBPACK_IMPORTED_MODULE_7___default()();
  var middlewares = [sagaMiddleware];
  var enhancer =  false ? undefined : Object(redux__WEBPACK_IMPORTED_MODULE_4__["compose"])(redux__WEBPACK_IMPORTED_MODULE_4__["applyMiddleware"].apply(void 0, middlewares), !options.isServer && window.__REDUX_DEVTOOLS_EXTENSION__ // 배포할때는 빠지도록 리덕스가 다노출되버림
  ? window.__REDUX_DEVTOOLS_EXTENSION__() : function (f) {
    return f;
  });
  var store = Object(redux__WEBPACK_IMPORTED_MODULE_4__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_8__["default"], initState, enhancer);
  sagaMiddleware.run(_sagas__WEBPACK_IMPORTED_MODULE_9__["default"]);
  return store;
};

/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_5___default()(configureStore)(NodeBird)); // 고위 컴포넌트라고 부르는데 기존 컴포넌트의 기능을 확장해준다
...
/*!**************************!*\
  !*** ./reducers/post.js ***!
  \**************************/
/*! exports provided: LOAD_MAIN_POSTS_REQUEST, LOAD_MAIN_POSTS_SUCCESS, LOAD_MAIN_POSTS_FAILURE, LOAD_HASHTAG_POSTS_REQUEST, LOAD_HASHTAG_POSTS_SUCCESS, LOAD_HASHTAG_POSTS_FAILURE, LOAD_USER_POSTS_REQUEST, LOAD_USER_POSTS_SUCCESS, LOAD_USER_POSTS_FAILURE, LOAD_IMAGES_REQUEST, LOAD_IMAGES_SUCCESS, LOAD_IMAGES_FAILURE, REMOVE_IMAGE, ADD_POST_REQUEST, ADD_POST_SUCCESS, ADD_POST_FAILURE, LIKE_POST_REQUEST, LIKE_POST_SUCCESS, LIKE_POST_FAILURE, UNLIKE_POST_REQUEST, UNLIKE_POST_SUCCESS, UNLIKE_POST_FAILURE, ADD_COMMENT_REQUEST, ADD_COMMENT_SUCCESS, ADD_COMMENT_FAILURE, LOAD_COMMENT_REQUEST, LOAD_COMMENT_SUCCESS, LOAD_COMMENT_FAILURE, RETWEET_REQUEST, RETWEET_SUCCESS, RETWEET_FAILURE, REMOVE_POST_REQUEST, REMOVE_POST_SUCCESS, REMOVE_POST_FAILURE, addPost, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOAD_IMAGES_REQUEST", function() { return LOAD_IMAGES_REQUEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOAD_IMAGES_SUCCESS", function() { return LOAD_IMAGES_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOAD_IMAGES_FAILURE", function() { return LOAD_IMAGES_FAILURE; });
...
var initState = {
  ...
  mainPosts: [{
    ...
    content: "첫번째게시글",
    img: "https://cdn.designbyhumans.com/product_images/p/898810.f56.f949aS7ay1Cm2MjUAAA-650x650-b-p.jpg"
  }],
  // 화면에 보일 포스트
...
var LOAD_IMAGES_REQUEST = "LOAD_IMAGES_REQUEST";
var LOAD_IMAGES_SUCCESS = "LOAD_IMAGES_SUCCESS";
var LOAD_IMAGES_FAILURE = "LOAD_IMAGES_FAILURE";
...
var ADD_POST_TO_ME = "ADD_POST_TO_ME"; // 중요한 액션, 리듀서의 단점때문에 만듬
